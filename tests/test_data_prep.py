...
def test_prepare_for_train_aligns_benchmark_forward_returns_by_prediction_date():
    ...
    df.loc[df["Ticker"] == "AAA", "Close"] = [100.0, 110.0, 121.0, 133.1, 146.41, 161.051]
    df.loc[df["Ticker"] == "SPY", "Close"] = [200.0, 202.0, 204.02, 206.0602, 208.120802, 210.20201]
